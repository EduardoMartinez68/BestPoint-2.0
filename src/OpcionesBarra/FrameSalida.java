...
public class FrameSalida extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(labelCantidadDinero, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void guardarDinero(){
        ...
        //esta comprobacion sirve para que no pueda ingresar dinero en el frame de salida de dinero
        if(dineroSacado<0){
            new MessageError(this,"El dinero sacado no puede tener un numero negativo");
        }else{
            if(dineroTotal>=0){
