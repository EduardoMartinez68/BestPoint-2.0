...
public class FrameNoWifi extends javax.swing.JFrame {
    int mouseX,mouseY;
    Color colorBtnHover=new Color(46,69,209);
    Color ColorBtn=new Color(22,21,60);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("No existe conexion");
        ...
        jLabel3.setText("No hay conexion a internet");
        ...
        jLabel5.setText("Revisa tu conexion o intentelo de nuevo");

        btnEnviar.setBackground(new java.awt.Color(22, 21, 60));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 381, 443, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/conexionWifi.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameNoWifi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
