...
public class MessageError extends javax.swing.JDialog {
    ...
    public MessageError(JFrame fram,String mensaje) {
        super(fram, true);
        this.fram = fram;
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/error-gif.png"))); // NOI18N
